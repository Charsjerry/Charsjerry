...
<h1>Hi, I'm Charles Jeremiah Nosa!

## Professional Statements
Entry-level Digital Forensics Investigator with a strong passion for uncovering and preserving digital
evidence, skilled in data recovery, incident analysis, and forensic tools. Adapt at maintaining data
...
Leadership | Growth and operation management

### Volunteering/ Mentorship project:
* Cybersecurity Volunteer (2024) at Cyberguard lounge (Voluntering/Mentorship)
* Digital Forensics (2025) at Greyhawk & forensics in cybersecurity
* Dclm community (2025) Title: Preserved
* Cybersecurity Volunteer (2024) at Center for Cyber Security Studies & Research
...
* Nmap
* Excel
* JERA 5.O (A philippine digital forensics tool)
* Hawk eye -Ai (A philippine digital forensics tool)
* Forensics Suite (A philippine digital forensics tool)
* Greyhawk captain (A philippine digital forensics tool)
